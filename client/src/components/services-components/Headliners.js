      ...
      <div className='service-wrapper' id='headliners'>
        ...
        <div className='quote-block'>
          <p className='quote-paragraph'>
            "Almost every automobile, from a Kia Rio to a Bentley Continental GT
            has something in common. The car manufacturers have decided to
            ...
            finished material and the headliner board breaks down from heat and
            turns to dust. No one can secure the finished material to the broken
            down foam. The solution is to remove the trim panels and carefully
            take the hard headliner board out of the car. Then the board is
            cleaned and prepared with solvent. The next step is to glue new
          ...
          <p className='quote-paragraph'>
            ...
            headliner board. Leave with your car and then you will return in the
            afternoon for us to install your hard headliner board with the new
            material."
          </p>
