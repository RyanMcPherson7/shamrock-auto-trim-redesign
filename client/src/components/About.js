        ...
        <div id='about-grid-wrapper'>
          <div className='quote-block'>
            <p className='quote-paragraph'>
              ...
              father <span className='special'>Dan McPherson</span> in 1968.
              He's a master craftsman who stills works a full day. My
              mother&nbsp;
              <span className='special'>Kathy</span> answers the phone, gives
              estimates, makes lunch, runs the office, and keeps us all in line.
              My brother <span className='special'>Lee</span> is the shop
              foreman who always knows what's going on with each job. My whole
              family was born and raised in{' '}
              <span className='special'>Miami</span>.
            </p>
            <p className='quote-paragraph'>
              Recently, our previous mascot Fraiser, a Jack Russel terrier,
              sadly passed away. Fraiser was a&nbsp;
              <span className='special'>customer favorite</span> who came to
              work with us every day for 17 years. Fraiser even received
              Christmas cards from customers and some would&nbsp;
              <span className='special'>stop in just to say hello</span> to him
              or bring him a dog biscuit. Today, we have a cockapoo named Bella
              who loves greeting customers!"
            </p>
          ...
          <div className='quote-block'>
            <p className='quote-paragraph'>
              "Our business is decorated with antique signs and neon clocks.
              Many of our customers have told us that our workshop feels like
              they have been transported back in time! Over the years, we've had
              a few antique cars, such as a 1935 Ford truck, 1954 Packard
              convertible, 1936 Ford Phaeton convertible, and currently a 2002
              Mini Cooper. We try to keep current with the changing trends by
              attending SEMA,&nbsp;
          ...
          <div className='quote-block'>
            <p className='quote-paragraph'>
              ...
              and dashboard. On the other hand, you may only need us to change
              one section on a seat or replace a headliner. I can't emphasize
              this enough,{' '}
              <span className='special'>no job is too big nor small</span>
              ."
            </p>
            <p className='quote-author'>
